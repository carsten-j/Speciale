...
\begin{equation}
   p=\sum_{i=1}^{n+1}p(a_i)\lambda_i (2\lambda_i-1) + 
     \sum_{\begin{Sb} i,j=1 \\ i<j\end{Sb}}^{n+1} p(a_{ij}) 4\lambda_i
     \lambda_j ,  
\end{equation}
...
\begin{minipage}[b]{.45\linewidth}
  \centering\psfig{figure=lovnet.ps,width=\linewidth}
  \caption{Eksempel på tilladt triangulering\label{lov}} 
\end{minipage}\hfill
\begin{minipage}[b]{.45\linewidth}
  \centering\psfig{figure=ulovnet.ps,width=\linewidth}
...
\begin{figure}[htbp]
  ...
  \begin{center}
    \begin{picture}(241,256)(0,0)
      \put(1,1){\psfig{figure=support.ps}}
    \end{picture}
  \end{center}
...
\begin{figure}[htbp]
  ...
  \begin{center}
    \begin{picture}(376,175)(0,0)
      \put(1,1){\psfig{figure=argyris.ps}}
    \end{picture}
  \end{center}
